...
docker compose --env-file "$ENV_FILE" -f "$COMPOSE_FILE" run --rm api python -m app.shadow_migration_verify
...
echo "F6A synthetic shadow migration foundation applied and verified at ${CURRENT_SHA}."
