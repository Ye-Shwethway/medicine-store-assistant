...
docker compose --env-file "$ENV_FILE" -f "$COMPOSE_FILE" run --rm api python -m app.ledger_verify
...
echo "F4 synthetic ledger foundation applied and verified at ${CURRENT_SHA}."
